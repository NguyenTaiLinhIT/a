    ...
    public partial class frmNhanVien : Form
    {
        ...
        public void LoadNhanVien()
        {
            ...
            foreach (var nhanvien in _inhanvienservice.GetAll())
            {
                ...
                //string formatbirthday = nhanvien.BirthDay.ToString("dd/MM/yyyy");
                //dgv_danhsach.Columns[0].Visible = false;
                //dgv_danhsach.Rows.Add(nhanvien.Id, manv, nhanvien.Name, nhanvien.Email, nhanvien.PhoneNumber, nhanvien.BirthDay.ToString("dd/MM/yyyy"), nhanvien.Sex == true ? "Nam" : "Nữ", Convert.ToBoolean(nhanvien.Role) == true ? "Quản Lý" : "Nhân Viên", nhanvien.UserName, nhanvien.PassWord, nhanvien.Status == true ? "Đang Hoạt Động" : "Không Hoạt Động");
                //STT++;
                //}
            }
        }
        ...
        private void btn_suanv_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                employee.Email = txb_hovaten.Text;
